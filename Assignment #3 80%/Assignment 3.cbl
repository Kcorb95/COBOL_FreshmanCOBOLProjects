       ...
       01 NUMBRWN-FTR.
          05 FILLER          PIC X(15).
          05 TOTAL-BROWN     PIC X(25)
                               VALUE "TOTAL BROWN EYED MODELS: ".
          05 BRWNCNT-FTR     PIC 9(2).

       01 AVERAGEHEIGHT-FTR.
          05 FILLER          PIC X(15).
          05 AVERAGE-HEIGHT  PIC X(30)
                               VALUE "AVERAGE HEIGHT OF ALL MODELS: ".
          05 AVHGT-FTR       PIC 9(2).

       01 AVERAGEWEIGHT-FTR.
          05 FILLER          PIC X(15).
          05 AVERAGE-WEIGHT  PIC X(30)
                               VALUE "AVERAGE WEIGHT OF ALL MODELS: ".
          05 AVWGT-FTR       PIC 9(3).
       ...
       01 FORMATING-WK.
          ...
          05 HEIGHT-CNT          PIC 9(5).
          05 WEIGHT-CNT          PIC 9(5).
       ...
       BLONDE-CNT,WEIGHT-CNT, HEIGHT-CNT.
       MOVE 59 TO LINE-CNT.
       ...
       200-MOVER-JOB.
           ...
           ADD HEIGHT-IN TO HEIGHT-CNT.
           MOVE HEIGHT-IN TO HEIGHT-OUT.
           ADD WEIGHT-IN TO WEIGHT-CNT.
       ...
       300-DONE-JOB.
           ...
           COMPUTE AVWGT-FTR = WEIGHT-CNT / NUM-OMOD.
           COMPUTE AVHGT-FTR = HEIGHT-CNT / NUM-OMOD.
           ...
           WRITE OUT-REC FROM AVERAGEHEIGHT-FTR AFTER ADVANCING 2 LINES.
           WRITE OUT-REC FROM AVERAGEWEIGHT-FTR AFTER ADVANCING 2 LINES.
